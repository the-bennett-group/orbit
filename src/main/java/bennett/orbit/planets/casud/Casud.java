...
public class Casud {
    ...
    public static final ResourceKey<DimensionType> CASUD_TYPE_KEY = OrbitUtils.makeKey("casud_type", Registry.DIMENSION_TYPE_REGISTRY);

    public static final DimensionType TYPE = DimensionType.create(OptionalLong.empty(), true, false, true, true, 1.0, false, false, true, false, false, 0, 256, 192, OrbitTags.INFINIBURN_CASUD, DimensionType.OVERWORLD_EFFECTS, 0.25f);
