package the.bennett.group.orbit.world.planets.casud.dimension;
...
import the.bennett.group.orbit.world.planets.util.DimensionWrapper;
...
public class CasudDimensionWrapper implements DimensionWrapper {
    ...
    public CasudDimensionWrapper(long seed) {
        name = "casud";
        ...
        chunkGenerator = new CasudChunkGenerator(biomeSource, seed);
    }
